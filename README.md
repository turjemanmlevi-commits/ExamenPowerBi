...
- The **Messages** section sends your exercise files (PDF, Word, Excel, CSV, screenshots) to the tutor and returns a step-by-step solution.
...
- `APP_PASSWORD` (optional) — if set, the Messages section asks for this password before sending. Without it, anyone who has the URL can use the Messages section on your API credit, so set a spend limit in the API console.
...
## API key (only for the Messages section)
